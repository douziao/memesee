...
class AuthServiceTest {
    ...
    @Test
    void registerRejectsDuplicateUsernameWithoutConsumingInviteOrHashingPassword() {
        ...
        verify(inviteCodeRepository, never()).findByCodeForUpdate(anyString());
    ...
    void registerRejectsInvalidInviteWithoutSavingUser() {
        ...
        assertThatThrownBy(() -> authService.register(new RegisterRequest(
                ...
                .isInstanceOfSatisfying(ApiException.class, exception -> {
                    ...
                    assertThat(exception.getCode()).isEqualTo(ApiErrorCode.VALIDATION_FAILED);
                });
